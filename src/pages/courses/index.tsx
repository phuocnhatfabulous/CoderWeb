    ...
    <DefaultLayout title={'Khóa học | ITUTC2'}>
      {userRole ? (
        ...
        <div className='items-center justify-center w-full h-full flex'>
          <p className='text-center font-bold text-dark-blue text-xl shadow-md'>Bạn không có quyền truy cập trang này. Quay lại <Link href='/' className='underline underline-offset-1 text-brand-orange'>Trang chủ</Link></p>
        </div>
      )}
    </DefaultLayout>
  );
