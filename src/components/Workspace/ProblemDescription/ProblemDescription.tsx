    ...
    return (
        <div className="bg-dark-layer-1">
            ...
            <div className="flex h-11 w-full items-center pt-2 bg-dark-layer-2 text-white overflow-x-hidden">
                <div
                    className={
                        "bg-dark-layer-1 rounded-t-[5px] px-5 py-[10px] text-base font-bold cursor-pointer"
                    }
                >
                    Nội dung
                </div>
                                ...
                                <div key={example.id}>
                                    ...
                                    <div className="example-card">
                                        <pre>
                                            ...
                                            {example.inputText}
                                            <br />
                                            <div className="text-white font-semibold">Đầu ra:</div>
                                            {example.outputText} <br />
                                            {example.explanation && (
                                                <>
                                                    <div className="text-white font-semibold">Giải thích:</div>{" "}
                                                    {example.explanation}
                                                </>
                                            )}
                                        </pre>
