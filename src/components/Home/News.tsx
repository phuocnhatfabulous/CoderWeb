            ...
            <div className="w-1/2">
                <a href="" className="h-full select-text">
                    <div className=" w-full h-full relative p-6 flex flex-col gap-4 select-text">
                        <Image
                            src="/news-1.jpg"
                            alt="Ngày nhà giáo Việt Nam 20/11/2023 tại UTC2"
                            width={500}
                            height={500}
                            className="object-cover shrink-0 w-full h-3/4 rounded-xl"
                        />
                        <span className="select-text">
                            {' '}
                            Trang trọng và đầy cảm xúc trong Chương trình chào
                            mừng ngày Nhà giáo Việt Nam 20/11 của UTC2
                        </span>
                    </div>
                </a>
            </div>
