            ...
            <div className="rounded-md p-8 bg-white w-9/12">
                <form>
                    <div className="flex flex-col mb-4">
                        <label className='text-lg font-semibold' htmlFor="title">Tựa đề</label>
                        <input
                    ...
                    <div className="flex flex-col mb-4">
                        <label htmlFor="description" className='text-lg font-semibold'>Mô tả</label>
                        <textarea
                    ...
                    {errors && (
                        <div className="error bg-red-200 text-red-600 p-2 rounded-md mb-4">{`Please include: ${errors}`}</div>
                    )}
                    <button
                        type="submit"
